...
#     ]
#     for agent in agents:
#         agent.restore(path + f"/agent{np.random.randint(0,4)}")
...
# np.save("./tr_curriculum-4p-random.npy",total_rewards_4p)

# path = "./RWARE16x20-16p-walltime/trained_models/TEST1/u1000000"
...
#     ]
#     for agent in agents:
#         agent.restore(path + f"/agent{np.random.randint(0,16)}")
...
# np.save("./tr_curriculum-16p-random.npy",total_rewards_16p)

# path = "./RWARE16x20-16p-hard-walltime/trained_models/TEST1/u1000000"
...
# np.save("./tr_curriculum-16p-hard-random.npy",total_rewards_16p_hard)
...
total_rewards_4p = np.load("./RWARE16x20-16p-walltime/tr_curriculum-4p-random.npy")
total_rewards_16p = np.load("./RWARE16x20-16p-walltime/tr_curriculum-16p-random.npy")
total_rewards_16p_hard = np.load("./RWARE16x20-16p-walltime/tr_curriculum-16p-hard-random.npy")
total_rewards_16p_cur = np.load("./RWARE16x20-16p-walltime/tr_curriculum-16p-cur-random.npy")
...
plt.title("Comparison scaling number of agents randomly via transfer learning or curriculum learning")
